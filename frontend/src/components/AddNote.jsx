...
export default function AddNote() {
  ...
  return (
    <div className="text-center">
      ...
      <h3 className="mt-2 text-sm font-semibold text-white">{!userNotes ? "No notes yet" : "Add a note"}</h3>
      <p className="mt-1 text-sm text-gray-400">{!userNotes && "Get started by creating a new project."}</p>
      <div className="mt-6">
        {/* <button
          type="button"
